...
class SolictExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    {
        $data = Solicitudot::select("idsolicitudOT", "solicitante", "nom_E", "nom_ubi", "referencia", "fecha", "fechaCierre", "nombrE", "tipoC", "nom_espe", "detalle", "detallSP")
    ...
    {
        return ["ID", "SOLICITANTE", "RESPONSABLE", "UBICACIÓN", "REFERENCIA", "FECHA", "FECHA_CIERRE", "ESTADO", "CRITICIDAD", "ESPECIALIDAD", "DETALLE", "DETALLE_SOLUCION"];
    }
}
