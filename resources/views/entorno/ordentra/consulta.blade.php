...
<script>
    ...
    $('.btn-ver-detalle').on('click', function() {
        ...
        var fechaEntrega = fe.substring(0, 10); // Recortar la cadena de fecha para eliminar la hora y los minutos
        var formattedDateE = moment(fechaEntrega, 'YYYY-MM-DD').format('YYYY-MM-DD');
